...
contract NWS01NFT is ERC721URIStorage {
    ...
    string firstSvg =
        unicode"<svg xmlns='http://www.w3.org/2000/svg' width='400' height='600'><rect width='400' height='600' style='fill:rgb(6, 10, 31);stroke-width:3' /><text x='25' y='75' font-family='Verdana' font-size='60'>🌙</text><text x='90' y='165' font-family='Verdana' font-size='45' fill='rgb(250, 204, 21)'>NIGHTS &amp;</text><text x='80' y='200' font-family='Verdana' font-size='45' fill='rgb(250, 204, 21)'>WEEKENDS</text><text x='130' y='390' font-family='Verdana' font-size='140'>🦄</text><text x='120' y='445' font-family='Verdana' font-size='30' fill='rgb(250, 204, 21)'>SEASON 01</text><line x1='0' y1='475' x2='400' y2='475' style='stroke:rgb(255,255,255);stroke-width:3' /><text x='80' y='550' font-family='Verdana' font-size='50' fill='white'>";
